...
'description' => __('This is your profile page. You Change email and password and also name. thanks for using our product'),
'class' => 'col-lg-7'
])
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="col-12 mb-0">{{ __('Edit Password') }}</h3>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                                ...
                                <input type="file" name="profile_image"
                                        class="form-control file-input  @error('profile_image') invalid-input @enderror"

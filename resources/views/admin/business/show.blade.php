...
array(
'class'=>'info',
'title'=>"Business Information",'description'=>'',
'icon'=>'fas fa-home',
'breadcrumb'=>array([
        ...
        <div class="col">
            <div class="card shadow mb-3">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-2 text-center">
                            <label for="" class="text-default">CATEGORY</label>
                            <h4>{{$business->Businesssector->sector_name}}</h4>
                        </div>

                        <div class="col-5 text-center">
                            <label for="" class="text-default">BUSINESS NAME</label>
                ...
                <card-content class="ml-4">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <span for="" class="text-default">Business Description</span>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-4">
                            <span for="" class="text-default">Email Address</span>
                                <h5>{{$business->business_email}}</h5>
                        </div>
                        <div class="col-4">
                            <span for="" class="text-default">Business Contact</span>
                    ...
                    <form action="{{ route('acceptrejectbusiness') }}" method="POST" id="accept_reject">
                        @csrf
                        <div class="row ml-3 mr-3 pb-4">
                            ...
                            @if ($business->status == "Pending")
                                ...
                                <div class="col-10">
                                    <input type="hidden" name="businessid" id="businessid" value="{{$business->id}}">
                            ...
                            <div class="col-3">
                                ...
                                <div class="col-10">
                                    <label for="">
                                        {{$business->response_info}}
                                    </label>
                                </div>
                                <div class="col-6">
                                    <h3>{{\Carbon\carbon::createFromFormat('Y-m-d', $business->response_date)->format('jS F Y')}}</h3>
                                </div>
                            @endif
                            <div class="col-2"></div>
                            <div class="col-2 pt-2">
                                    @if ($business->status == 'Accepted')
                                        <span class="badge badge-success">Business &nbsp; {{$business->status}}</span>
                                    @elseif($business->status == 'Rejected')
                                        <span class="badge badge-danger">Business &nbsp; {{$business->status}}</span>
                                    @endif
                            </div>
                            <div class="col-2">
                                <button href="{{route('business.destroy', $business->id)}}"
                                    type="button" class="btn btn-sm btn-outline-danger btn-icon m-1 delbusiness">
...
<script>
    $(document).on('click', '.delbusiness', function(e){
            e.preventDefault();
            Swal.fire({
                title: "Are you sure?",
                        ...
                        success: function(result){
                            if(result.success == true){
                                ...
                                Swal.fire({
                                    position: 'top-end',
                                    type: 'success',
                                    title: 'Business has been deleted',
                                    showConfirmButton: false,
                                    timer: 1500
                                });
                                location.href = '{{ route('business.show', $business->id) }}';
                            } else {
